...
//COMUNICADOS: (PATRON)
    ...
    private void pantallaMenuGestionComunicados() {
        ...
        if(salida.equalsIgnoreCase("si")){
            ...
            ctrl.cD.addComunicado(c);
            ctrl.cD.enviarComunicado(c);
...
//CLIENTES:
    ...
    private void mostrarAltaCliente() {
       ...
       do{
        ...
        ctrl.introducirDatosCliente(dni, nombre, telefono);
    ...
    private void mostrarModificarCliente() {
        ...
        ctrl.introducirDatosCliente(c.getDni(), nuevoNombre, nuevoTelefono);
    }
...
//VISUALIZAR:
    private void pantallaMenuVisualizacionDatos() {
        ...
        System.out.println(ctrl.cD.toString());
